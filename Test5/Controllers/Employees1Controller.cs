...
namespace Test5.Controllers
{
    public class Employees1Controller : Controller
    {
        ...
        public Employees1Controller(Test5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StudentId,FirstName,LastName,PhoneNumber,Email")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,FirstName,LastName,PhoneNumber,Email")] Employee employee)
        {
